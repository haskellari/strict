...
-- "Data.Strict.Sequence.Autogen". Further notes are available in the file sorting.md
-- (in this directory).

module Data.Strict.Sequence.Autogen.Internal.Sorting
  (
   -- * Sort Functions
   sort
  ,sortBy
...
-- and 'Data.Strict.Sequence.Autogen.foldMapWithIndex', which can alternate between
...
-- | A 'Data.Strict.Sequence.Autogen.foldMapWithIndex'-like function, specialized to the
-- 'Data.Semigroup.Option' monoid, which takes advantage of the
-- internal structure of 'Seq' to avoid wrapping in 'Maybe' at certain
-- points.
